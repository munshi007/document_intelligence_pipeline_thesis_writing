...
\node[box, right=1.5cm of is_kv, fill=green!10] (vlm) {Two-Pass\\Markdown Harvest};
...
For instance, if a document batch is classified as an industrial catalog, the Agent retrieves the \textit{Industrial\_datasheet} instruction payload. This payload acts as an aggressive constraint matrix: "Focus entirely on technical specifications. Extract EVERY row of every parameter table... For EVERY connector (M12, M8, RJ45) list ALL pins with signal and function." 
